...
public class SoldierEntityRenderer extends ZombieEntityRenderer {
	private static final Identifier TEXTURE = Identifier.of(AdditionalWeapons.MOD_ID, "textures/entity/soldier.png");
