...
public class ModItems {
	...
	public static final Item POWERWILD_SPAWN_EGG = registerItem("powerwild_spawn_egg",
			new SpawnEggItem(ModEntities.POWERWILD, 0x6EA3C5, 0x374B63, new Item.Settings()));
